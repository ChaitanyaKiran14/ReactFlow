...
const ExtractData = ({ data, id }) => {
  ...
  const [extractQuery, setExtractQuery] = useState(data.extractQuery || "");
  ...
  // Update node data whenever inputs change
    ...
    <div className="bg-white rounded-lg shadow-md min-w-[32rem]">
      ...
      <div className="bg-pink-50 p-4 rounded-t-lg flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 text-sm">
          <span className="text-gray-600">{isEnabled ? "Yes" : "No"}</span>
      ...
      <div className="p-4 space-y-4">
        <div>
          <label className="block font-medium mb-1">Extract Query</label>
          <input
            type="text"
        ...
        <div>
          ...
          <input
            type="text"
            placeholder="[Optional] Provide additional context for extraction"
            value={context}
            onChange={(e) => {
        ...
        <div>
          ...
          <select
            ...
            className="w-full p-2 border border-gray-300 rounded mb-2 focus:ring-2 focus:ring-pink-500 focus:border-transparent"
          >
